...
/**
 * A websocket streaming terminal for counter caches.
 * @param props
 */

const logger = getLogger("CounterWSTerminalClient")

export default function CounterWebsocketTerminal(props: { url: any }) {

    const [messages, setMessages] = useState<string[]>([]);
    const params = useParams();
    const wsUrl = `${props.url}/api/ws/v1/counter/` + params.slug
