...
public class GatewayIdleStrategies {
    ...
    public static final Supplier<IdleStrategy> ingressAgentIdleStrategy =
            IdleStrategyConfig.supplier(BackoffIdleStrategy::new, "IDLE_STRATEGY_INGRESS_AGENT", IdleStrategyConfig.IDLE_STRATEGY_ENV);
