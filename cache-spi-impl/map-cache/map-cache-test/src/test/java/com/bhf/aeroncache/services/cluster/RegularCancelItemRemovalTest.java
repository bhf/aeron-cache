...
public class RegularCancelItemRemovalTest extends AbstractCancelItemRemovalTest<ReusableString, ReusableString, ReusableString, ReusableString> {
    ...
    public RegularCancelItemRemovalTest() {
