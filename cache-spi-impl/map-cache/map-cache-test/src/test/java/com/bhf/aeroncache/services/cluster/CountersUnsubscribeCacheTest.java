...
public class CountersUnsubscribeCacheTest extends AbstractUnsubscribeCacheTest<ReusableString, ReusableString, ReusableLong, ReusableString> {
    ...
    public CountersUnsubscribeCacheTest() {
