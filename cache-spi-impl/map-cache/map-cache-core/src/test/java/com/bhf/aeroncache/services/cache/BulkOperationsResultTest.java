...
import com.bhf.aeroncache.messages.BulkOperationResponseEncoder;
...
class BulkOperationsResultTest {
    ...
    void shouldDecodePassResultToCallbackHandler() {
        ...
        var length = 1024;
        bulkOperationResponseEncoder.wrapAndApplyHeader(requestBuffer, 0, headerEncoder);
        ...
        // Assert
        verify(
                cacheResponseDecoder, times(1)).decodeBulkCacheOpsResult(
