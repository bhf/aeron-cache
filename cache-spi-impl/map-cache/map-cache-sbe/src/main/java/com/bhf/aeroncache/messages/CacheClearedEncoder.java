...
public final class CacheClearedEncoder
{
    ...
    public CacheClearedEncoder status(final OperationStatus value)
    {
    ...
    public CacheClearedEncoder putCacheId(final DirectBuffer src, final int srcOffset, final int length)
    {
    ...
    public CacheClearedEncoder putCacheId(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public CacheClearedEncoder cacheId(final String value)
    {
        final byte[] bytes;
        try
        {
    ...
    public CacheClearedEncoder putRequestId(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public CacheClearedEncoder putRequestId(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public CacheClearedEncoder requestId(final String value)
    {
        final byte[] bytes;
        try
        {
