...
public final class CacheEntryCreatedEncoder
{
    ...
    public CacheEntryCreatedEncoder status(final OperationStatus value)
    {
    ...
    public CacheEntryCreatedEncoder putCacheId(final DirectBuffer src, final int srcOffset, final int length)
    {
    ...
    public CacheEntryCreatedEncoder putCacheId(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public CacheEntryCreatedEncoder cacheId(final String value)
    {
        final byte[] bytes;
        try
        {
    ...
    public CacheEntryCreatedEncoder putRequestId(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public CacheEntryCreatedEncoder putRequestId(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public CacheEntryCreatedEncoder requestId(final String value)
    {
        final byte[] bytes;
        try
        {
