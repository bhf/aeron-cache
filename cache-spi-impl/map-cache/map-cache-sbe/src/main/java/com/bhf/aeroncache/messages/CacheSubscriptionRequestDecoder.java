...
public final class CacheSubscriptionRequestDecoder
{
    ...
    private final CacheSubscriptionRequestDecoder parentMessage = this;
    ...
    public CacheSubscriptionRequestDecoder wrap(
    ...
    public CacheSubscriptionRequestDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public CacheSubscriptionRequestDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[CacheSubscriptionRequest](sbeTemplateId=");
