...
public final class DeleteCacheEncoder
{
    ...
    public DeleteCacheEncoder putCacheId(final DirectBuffer src, final int srcOffset, final int length)
    {
    ...
    public DeleteCacheEncoder putCacheId(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public DeleteCacheEncoder cacheId(final String value)
    {
    ...
    public DeleteCacheEncoder putRequestId(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public DeleteCacheEncoder putRequestId(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public DeleteCacheEncoder requestId(final String value)
    {
        final byte[] bytes = (null == value || value.isEmpty()) ? org.agrona.collections.ArrayUtil.EMPTY_BYTE_ARRAY : value.getBytes(java.nio.charset.StandardCharsets.UTF_8);
