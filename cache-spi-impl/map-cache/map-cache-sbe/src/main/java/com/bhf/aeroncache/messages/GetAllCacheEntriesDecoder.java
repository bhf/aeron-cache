...
public final class GetAllCacheEntriesDecoder
{
    ...
    private final GetAllCacheEntriesDecoder parentMessage = this;
    ...
    public GetAllCacheEntriesDecoder wrap(
    ...
    public GetAllCacheEntriesDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public GetAllCacheEntriesDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[GetAllCacheEntries](sbeTemplateId=");
    ...
    public GetAllCacheEntriesDecoder sbeSkip()
    {
        sbeRewind();
        skipCacheId();
        skipRequestId();
