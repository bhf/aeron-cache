...
public final class ClearCacheDecoder
{
    ...
    private final ClearCacheDecoder parentMessage = this;
    ...
    public ClearCacheDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public ClearCacheDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[ClearCache](sbeTemplateId=");
    ...
    public ClearCacheDecoder sbeSkip()
    {
        sbeRewind();
        skipCacheId();
        skipRequestId();
