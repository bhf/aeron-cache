...
public final class CacheUnsubscribeRequestDecoder
{
    ...
    private final CacheUnsubscribeRequestDecoder parentMessage = this;
    ...
    public CacheUnsubscribeRequestDecoder wrap(
    ...
    public CacheUnsubscribeRequestDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public CacheUnsubscribeRequestDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[CacheUnsubscribeRequest](sbeTemplateId=");
    ...
    public CacheUnsubscribeRequestDecoder sbeSkip()
    {
        sbeRewind();
        skipCacheId();
        skipRequestId();
