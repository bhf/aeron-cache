...
public final class CacheCreatedEncoder
{
    ...
    public CacheCreatedEncoder status(final OperationStatus value)
    {
    ...
    public CacheCreatedEncoder putCacheId(final DirectBuffer src, final int srcOffset, final int length)
    {
    ...
    public CacheCreatedEncoder putCacheId(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public CacheCreatedEncoder cacheId(final String value)
    {
        final byte[] bytes;
        try
        {
    ...
    public CacheCreatedEncoder putRequestId(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public CacheCreatedEncoder putRequestId(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public CacheCreatedEncoder requestId(final String value)
    {
        final byte[] bytes;
        try
        {
