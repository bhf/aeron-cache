...
public final class BulkOperationResponseDecoder
{
    ...
    private final BulkOperationResponseDecoder parentMessage = this;
    ...
    public BulkOperationResponseDecoder wrap(
    ...
    public BulkOperationResponseDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public BulkOperationResponseDecoder sbeRewind()
    {
        ...
        implements Iterable<ItemsDecoder>, java.util.Iterator<ItemsDecoder>
    {
        ...
        private final BulkOperationResponseDecoder parentMessage;
        private DirectBuffer buffer;
        private int count;
        private int index;
        private int offset;
        ...
        ItemsDecoder(final BulkOperationResponseDecoder parentMessage)
        {
        ...
        public short operationStatusRaw()
        {
        ...
        public StringBuilder appendTo(final StringBuilder builder)
        {
            ...
            builder.append(this.operationStatus());
            builder.append('|');
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[BulkOperationResponse](sbeTemplateId=");
    ...
    public BulkOperationResponseDecoder sbeSkip()
    {
        sbeRewind();
