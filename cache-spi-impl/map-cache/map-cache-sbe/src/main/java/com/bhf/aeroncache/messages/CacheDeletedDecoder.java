...
public final class CacheDeletedDecoder
{
    ...
    private final CacheDeletedDecoder parentMessage = this;
    ...
    public CacheDeletedDecoder wrap(
    ...
    public CacheDeletedDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public CacheDeletedDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[CacheDeleted](sbeTemplateId=");
    ...
    public CacheDeletedDecoder sbeSkip()
    {
        sbeRewind();
        skipCacheId();
        skipRequestId();
