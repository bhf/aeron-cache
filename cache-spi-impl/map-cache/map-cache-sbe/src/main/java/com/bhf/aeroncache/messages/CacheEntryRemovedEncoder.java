...
public final class CacheEntryRemovedEncoder
{
    ...
    public CacheEntryRemovedEncoder status(final OperationStatus value)
    {
    ...
    public CacheEntryRemovedEncoder putCacheId(final DirectBuffer src, final int srcOffset, final int length)
    {
    ...
    public CacheEntryRemovedEncoder putCacheId(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public CacheEntryRemovedEncoder cacheId(final String value)
    {
    ...
    public CacheEntryRemovedEncoder putRequestId(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public CacheEntryRemovedEncoder putRequestId(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public CacheEntryRemovedEncoder requestId(final String value)
    {
        final byte[] bytes = (null == value || value.isEmpty()) ? org.agrona.collections.ArrayUtil.EMPTY_BYTE_ARRAY : value.getBytes(java.nio.charset.StandardCharsets.UTF_8);
