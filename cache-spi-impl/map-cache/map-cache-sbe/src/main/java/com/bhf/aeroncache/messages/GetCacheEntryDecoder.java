...
public final class GetCacheEntryDecoder
{
    ...
    private final GetCacheEntryDecoder parentMessage = this;
    ...
    public GetCacheEntryDecoder wrap(
    ...
    public GetCacheEntryDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public GetCacheEntryDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[GetCacheEntry](sbeTemplateId=");
    ...
    public GetCacheEntryDecoder sbeSkip()
    {
        sbeRewind();
        skipCacheId();
        skipKey();
