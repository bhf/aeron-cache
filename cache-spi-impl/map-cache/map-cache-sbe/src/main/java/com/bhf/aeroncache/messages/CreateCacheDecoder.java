...
public final class CreateCacheDecoder
{
    ...
    private final CreateCacheDecoder parentMessage = this;
    ...
    public CreateCacheDecoder wrap(
    ...
    public CreateCacheDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public CreateCacheDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[CreateCache](sbeTemplateId=");
    ...
    public CreateCacheDecoder sbeSkip()
    {
        sbeRewind();
        skipCacheId();
        skipRequestId();
