...
public final class GetCacheStatsDecoder
{
    ...
    private final GetCacheStatsDecoder parentMessage = this;
    ...
    public GetCacheStatsDecoder wrap(
    ...
    public GetCacheStatsDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public GetCacheStatsDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[GetCacheStats](sbeTemplateId=");
    ...
    public GetCacheStatsDecoder sbeSkip()
    {
        sbeRewind();
        skipRequestId();
