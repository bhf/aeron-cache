...
public final class DeleteCacheDecoder
{
    ...
    private final DeleteCacheDecoder parentMessage = this;
    ...
    public DeleteCacheDecoder wrap(
    ...
    public DeleteCacheDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public DeleteCacheDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[DeleteCache](sbeTemplateId=");
    ...
    public DeleteCacheDecoder sbeSkip()
    {
        sbeRewind();
        skipCacheId();
        skipRequestId();
