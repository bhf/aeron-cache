...
public class AddRemoveCounterCacheEntryBenchmark {
    ...
    public void setup() {
        ...
        reusableCacheId.copyFrom("jmh-benchmark-counter-cache");
    ...
    @Benchmark
    public void addAndRemoveCounterCacheEntry(Blackhole bh) {
        seq++;
        reusableKey.clear();
        reusableKey.copyFrom("key-" + seq);

        reusableValue.clear();
        reusableValue.copyFrom(seq);
