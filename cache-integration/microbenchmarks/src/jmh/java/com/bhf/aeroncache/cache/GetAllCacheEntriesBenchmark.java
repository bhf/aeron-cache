...
public class GetAllCacheEntriesBenchmark {
    ...
    private GetAllCacheEntriesResult<ReusableString, ReusableString, ReusableString> getAllCacheEntriesResult;
    ...
    @Benchmark
    public void getAllCacheEntries(Blackhole bh) {
        seq++;
