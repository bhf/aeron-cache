...
class ClusteredIncrementCounterTests extends AbstractMultiStreamIncrementCounterTests {

    public ClusteredIncrementCounterTests() {
        super(new CounterTestEndpoints(), new SSEStreamingHelper(new SSECountersCacheTestEndpoints()));
    }

    @Override
    protected String getKnownCacheId() {
        return "ClusteredIncrementCounterTests-SSE";
    }
