...
class ClusteredDecrementCounterTests extends AbstractMultiStreamDecrementCounterTests {

    public ClusteredDecrementCounterTests() {
        super(new CounterTestEndpoints(), new SSEStreamingHelper(new SSECountersCacheTestEndpoints()));
    }

    @Override
    protected String getKnownCacheId() {
        return "ClusteredDecrementCounterTests-SSE";
    }
