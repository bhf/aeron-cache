...
class ClusteredMultiStreamDecrementCounterTests extends AbstractMultiStreamDecrementCounterTests {

    public ClusteredMultiStreamDecrementCounterTests() {
    ...
    protected String getKnownCacheId() {
        return "ClusteredMultiStreamDecrementCounterTests";
    }
