...
class ClusteredMultiStreamIncrementCounterTests extends AbstractMultiStreamIncrementCounterTests {

    public ClusteredMultiStreamIncrementCounterTests() {
    ...
    protected String getKnownCacheId() {
        return "ClusteredMultiStreamIncrementCounterTests";
    }
