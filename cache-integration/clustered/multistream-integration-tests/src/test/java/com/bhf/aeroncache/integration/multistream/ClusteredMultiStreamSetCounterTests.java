...
class ClusteredMultiStreamSetCounterTests extends AbstractMultiStreamSetCounterTests {

    public ClusteredMultiStreamSetCounterTests() {
    ...
    protected String getKnownCacheId() {
        return "ClusteredMultiStreamSetCounterTests";
    }
