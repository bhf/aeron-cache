...
A clustered cache built using Aeron, Agrona and SBE. UI with NextJS. Includes HTTP and websocket interfaces with support for multi-cache joins over websocket. Prometheus+cAdvisor and tracing with Jaeger+OTEL.
