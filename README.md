...
A key value store built using [Aeron](https://aeron.io/), [Agrona](https://github.com/aeron-io/agrona) and [SBE](https://github.com/aeron-io/simple-binary-encoding). RAFT clustered and fast by default. UI with NextJS, Shadcn and Tailwind. 
