...
/**
 * Node that launches the service for the {@link io.aeron.samples.cluster.tutorial.BasicAuctionClusteredService}.
 */
// tag::new_service[]
...
// end::new_service[]
{
    ...
    {
        final int nodeId = parseInt(args[0]);//parseInt(System.getProperty("aeron.cluster.tutorial.nodeId"));               // <1>
