...
import com.bhf.aeroncache.messages.CacheEntryResultDecoder;
import com.bhf.aeroncache.messages.CacheEntryResultEncoder;
...
class CacheEntryResultTest {
    ...
    void shouldDecodePassResultToCallbackHandler() {
        ...
        var length = 1024;
        cacheEntryResultEncoder.wrapAndApplyHeader(requestBuffer, 0, headerEncoder);
        ...
        try (MockedStatic<CacheResponseDecoder> encoder = Mockito.mockStatic(CacheResponseDecoder.class)) {
            ...
            // Assert
            encoder.verify(() ->
                            CacheResponseDecoder.decodeGetCacheEntryResult(
                                    any(CacheEntryResultDecoder.class),
