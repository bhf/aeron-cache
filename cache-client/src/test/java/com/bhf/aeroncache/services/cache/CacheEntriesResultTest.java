...
class CacheEntriesResultTest {
    ...
    public static final int CACHE_ENTRIES_TID = 1;
    ...
    void shouldDecodePassResultToCallbackHandler() {
        ...
        var timeStamp = 1L;
        var length = 1024;
        when(schemaDetailsProvider.getAllCacheEntriesResultId()).thenReturn(CACHE_ENTRIES_TID);

        requestBuffer.putShort(TID_INDEX, (short) CACHE_ENTRIES_TID);
