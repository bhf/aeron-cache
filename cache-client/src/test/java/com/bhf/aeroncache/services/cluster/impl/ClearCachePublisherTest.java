...
import com.bhf.aeroncache.messages.ClearCacheEncoder;
...
class ClearCachePublisherTest {
    ...
    void shouldEncodeClearCacheRequestAndOfferToCluster() {
        ...
        try (MockedStatic<CacheRequestEncoder> encoder = Mockito.mockStatic(CacheRequestEncoder.class)) {
            ...
            // Assert
            encoder.verify(() ->
                            CacheRequestEncoder.encodeClearCache(
                                    any(ClearCacheEncoder.class),
    ...
    void shouldPollEgressAndIdlePendingGetCacheEntryRequest() {
        ...
        // Act
        sut.clearCacheBlocking(requestId, cacheId);
