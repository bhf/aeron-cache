...
public final class GetCacheEntryEncoder
{
    ...
    private final GetCacheEntryEncoder parentMessage = this;
    ...
    public GetCacheEntryEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public GetCacheEntryEncoder wrapAndApplyHeader(
    ...
    public GetCacheEntryEncoder putKey(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public GetCacheEntryEncoder putKey(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public GetCacheEntryEncoder key(final String value)
    {
        final byte[] bytes;
        try
        {
    ...
    public GetCacheEntryEncoder putRequestId(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public GetCacheEntryEncoder putRequestId(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public GetCacheEntryEncoder requestId(final String value)
    {
        final byte[] bytes;
        try
        {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final GetCacheEntryDecoder decoder = new GetCacheEntryDecoder();
