...
public final class RemoveCacheEntryEncoder
{
    ...
    public RemoveCacheEntryEncoder putCacheId(final DirectBuffer src, final int srcOffset, final int length)
    {
    ...
    public RemoveCacheEntryEncoder putCacheId(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public RemoveCacheEntryEncoder cacheId(final String value)
    {
        final byte[] bytes;
        try
        {
    ...
    public RemoveCacheEntryEncoder putRequestId(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public RemoveCacheEntryEncoder putRequestId(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public RemoveCacheEntryEncoder requestId(final String value)
    {
        final byte[] bytes;
        try
        {
