...
public final class CacheDeletedEncoder
{
    ...
    public CacheDeletedEncoder putRequestId(final DirectBuffer src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public CacheDeletedEncoder putRequestId(final byte[] src, final int srcOffset, final int length)
    {
        if (length > 1073741824)
        {
            throw new IllegalStateException("length > maxValue for type: " + length);
    ...
    public CacheDeletedEncoder requestId(final String value)
    {
        final byte[] bytes;
        try
        {
