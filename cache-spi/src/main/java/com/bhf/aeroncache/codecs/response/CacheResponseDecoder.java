...
public interface CacheResponseDecoder<I extends Reusable, K extends Reusable, V extends Reusable> {
    ...
    void decodeItemRemovalCancelled(DirectBuffer buffer, int offset, CancelItemRemovalResult<I, K> cancelItemRemovalResult);

    void decodePatchValueResult(DirectBuffer buffer, int offset, PatchValueResult<I, K, V> patchValueResult);
    ...
    void decodeAllTimersResult(DirectBuffer buffer, int offset, AllTimersResult<I, K> allTimersResult);

    void decodeCacheSubscribeResult(DirectBuffer buffer, int offset, CacheSubscriptionResult<I,K,V> cacheSubscriptionResult);

    void decodeCacheUnsubscribeResult(DirectBuffer buffer, int offset, CacheUnsubscribeResult<I> cacheUnsubscribeResult);

    void decodeCacheEntryUpdated(DirectBuffer buffer, int offset, CacheEntryUpdateResult<I, K, V> cacheEntryUpdateResult);

    void decodeBulkCacheOpsResult(DirectBuffer buffer, int offset, BulkCacheOpsResult<I, K, V> bulkCacheOpsResult);
}
