...
@Flyweight
public class IncrementCounterResult<I extends Reusable, K extends Reusable> implements Reusable<IncrementCounterResult<I, K>> {
    ...
    @Override
    public void copyFrom(IncrementCounterResult<I, K> source) {
    ...
    @Override
    public void copyFrom(Reusable<IncrementCounterResult<I, K>> source) {
        this.copyFrom(source.value());
    }

    @Override
    public IncrementCounterResult<I, K> value() {
        return this;
    }
}
