...
@Flyweight
public class DecrementCounterResult<I extends Reusable, K extends Reusable> implements Reusable<DecrementCounterResult<I, K>> {
    ...
    @Override
    public void copyFrom(DecrementCounterResult<I, K> source) {
    ...
    @Override
    public void copyFrom(Reusable<DecrementCounterResult<I, K>> source) {
        this.copyFrom(source.value());
    }

    @Override
    public DecrementCounterResult<I, K> value() {
        return this;
    }
}
