...
/**
 * Decoded version of a request to patch the value of a cache entry.
 *
...
@Flyweight
public class PatchValueRequestDetails<I extends Reusable, K extends Reusable, V extends Reusable> implements Reusable<PatchValueRequestDetails<I, K, V>> {
     ...
     */
    @Override
    public void copyFrom(PatchValueRequestDetails<I, K, V> source) {
    ...
    @Override
    public void copyFrom(Reusable<PatchValueRequestDetails<I, K, V>> source) {
        this.copyFrom(source.value());
    }

    @Override
    public PatchValueRequestDetails<I, K, V> value() {
        return this;
    }
}
