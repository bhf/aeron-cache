...
public final class SymbolSidedQuoteEncoder
{
    ...
    public SymbolSidedQuoteEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public SymbolSidedQuoteEncoder symb(final short value)
    {
    ...
    public SymbolSidedQuoteEncoder price(final long value)
    {
    ...
    public SymbolSidedQuoteEncoder qty(final long value)
    {
    ...
    private final QuoteSideEncoder side = new QuoteSideEncoder();

    public QuoteSideEncoder side()
    {
        side.wrap(buffer, offset + 17);
        return side;
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final SymbolSidedQuoteDecoder decoder = new SymbolSidedQuoteDecoder();
