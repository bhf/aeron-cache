...
public final class MarketStateDecoder
{
    ...
    private final MarketStateDecoder parentMessage = this;
    ...
    public MarketStateDecoder wrap(
    ...
    public MarketStateDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    {
        return MarketStateIdentifier.get(((short)(buffer.getByte(offset + 13) & 0xFF)));
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append("[MarketState](sbeTemplateId=");
