...
public final class SymbolAskQuoteEncoder
{
    ...
    public SymbolAskQuoteEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public SymbolAskQuoteEncoder symb(final short value)
    {
    ...
    public SymbolAskQuoteEncoder price(final long value)
    {
    ...
    public SymbolAskQuoteEncoder qty(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final SymbolAskQuoteDecoder decoder = new SymbolAskQuoteDecoder();
